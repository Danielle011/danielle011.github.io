...
내용이 많은 관계로 크게 Daily plot, Glucose tab, Meal tab, Activity tab 이렇게 4가지 구성 중에서, 이번 포스트에서 Daily plot, Glucose tab 진행 내용까지 정리하고 다음 포스트에서 나머지를 정리하고자 한다.
